...
ЛИЧНЫЙ МЕСЯЦ — тактика внутри года, не отдельно а как шаг в направлении года:
{month_text}

ЛИЧНЫЙ ДЕНЬ — фокус сегодня в контексте месяца и года:
{day_text}

ЛОГИКА: Покажи как именно {name} с её моделью мышления проживает этот период.
Пример правильного анализа: "Ты — {model_name} в году закрепления. Это значит что твоя природа хочет генерировать и менять, а год говорит — удержи и доведи до конца. Вот где возникает твоё главное напряжение этого года..."

СТИЛЬ — попадать в точку, не умничать:
Хорошо: "Идеи у тебя рождаются быстро. Настолько быстро, что ты иногда бросаешь одну на полпути — потому что уже горит следующая."
Плохо: "Твоя генеративность является суперсилой но требует дисциплины воплощения."

ЗАПРЕЩЕНО:
- Оценки личности: "ты бросаешь", "ты мечешься", "ты не можешь"
- Мотивационные клише: "рождена чтобы", "суперсила", "внутренний огонь"
- Диагнозы: "твоя проблема в том что", "ты склонна к"
- Грамматические ошибки и просторечия
- markdown звёздочки решётки

ПРАВИЛЬНЫЙ ТОН — наблюдение без оценки:
Плохо: "Ты бросаешь идеи на полпути"
Хорошо: "Идеи приходят быстро — иногда настолько быстро, что следующая загорается раньше чем закончена первая"

Плохо: "Твоя проблема в том что ты критикуешь"
Хорошо: "Критический взгляд — это твой инструмент. Сейчас важно направить его внутрь процесса, а не на результат"

Обращение: ТЫ. {g}. Короткие абзацы — максимум 3 предложения. Говори как умный друг который хорошо знает этого человека."""

    b = {
        "me": [
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>✨ Кто ты есть на самом деле</b>\nНачни с этого тега. 2-3 абзаца. Говори только о личности — без упоминания года, месяца, дня. Пиши так точно и лично, чтобы человек подумал вау это прям про меня. Наблюдение, не оценка. Никаких повторений одних и тех же слов.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌿 Твои настоящие сильные стороны</b>\nНачни с этого тега. Только о сильных сторонах личности. Без упоминания года и дня. Образно и конкретно — как именно это работает в жизни. Никаких повторений.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🔺 Где ты можешь себе мешать</b>\nНачни с этого тега. Только о личностных паттернах. Мягко, с теплом — не критика, а понимание механизма. Год и день не упоминать. Никаких повторений.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌱 Как превратить это в силу прямо сейчас</b>\nНачни с этого тега. 1-2 конкретных действия для этого человека. Можно коротко упомянуть контекст года или месяца только если это усиливает совет. Никаких повторений.",
        ],
        "year": [
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🧭 Что происходит в этом году</b>\nКак вектор года взаимодействует с моделью мышления {name} — где усиление, где напряжение. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>✨ Где ты сейчас сильнее всего</b>\nЧто открывается именно для неё в этот период. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🔺 Что может тянуть назад</b>\nГде её особенности могут сыграть против неё в этот год. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌱 Что важно прямо сейчас</b>\n1-2 конкретных шага для этого периода. Начни с этого тега.",
        ],
        "month": [
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🧭 Тактика этого месяца</b>\nМесяц в контексте года — как тактика месяца работает через вектор года для {name}. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>✨ Возможности месяца</b>\nЧто открывается именно сейчас с учётом её модели. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🔺 Риски месяца</b>\nГде её особенности могут усилить сложности именно в этом месяце. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌱 Шаги на ближайшие 2 недели</b>\nКонкретно и применимо. Начни с этого тега.",
        ],
        "day": [
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🧭 Энергия сегодняшнего дня</b>\nСуть дня через призму модели {name}. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌿 Рекомендации на сегодня</b>\n2-3 конкретных действия. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🔺 Риски на сегодня</b>\n2-3 конкретных риска для неё сегодня. Начни с этого тега.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌱 Главный фокус дня</b>\nОдна конкретная задача. Начни с этого тега.",
        ],
    }
