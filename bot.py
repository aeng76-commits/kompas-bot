...
Пиши так чтобы человек читал и думал "это прям про меня, откуда они знают?"
Не диагноз — а узнавание. Не оценка — а точное наблюдение.
Каждое предложение должно быть новым — никаких повторов одной мысли.
Короткие абзацы — максимум 3 предложения. Живой разговорный язык.

ЗАПРЕЩЕНО:
- Слова: "трещины", "хаос", "нестабильность", "напряжение", "тормозит", "нытьё", "застреваешь", "зависаешь", "ломается", "проблема", "слабость", "мешает", "сложно", "тяжело", "страдаешь", "беспокойство", "тревога"
- Фразы: "ты склонна к", "твоя проблема", "ты испытываешь", "это мешает", "это тормозит"
- Клише: "суперсила", "рождена чтобы", "внутренний огонь", "кстати"
- Диагнозы и оценки личности
...
СТИЛЬ: живой, точный, эмоциональный. Каждое предложение новое. Без повторов.
...
3 абзаца. Говори только о личности {name} — без года, месяца, дня.
Первый абзац — самое точное и неожиданное наблюдение о том как она видит мир. Начни не с "ты" а с конкретного образа или ситуации.
Второй абзац — как это проявляется внутри, что она чувствует когда её природа работает.
Третий абзац — обратная сторона этого же качества — не слабость, а напряжение которое из этого возникает.
Текст должен вызывать эффект "это прям про меня".""",
...
Начни с этого тега на первой строке.
Покажи как вектор года взаимодействует с моделью мышления {name}.
Начни с конкретного образа этого столкновения — где природа личности и требование года создают напряжение или усиление.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>✨ Где ты сейчас сильнее всего</b>
Начни с этого тега на первой строке.
Что открывается именно для {name} в этот период с учётом её модели мышления.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>🔺 Что может тянуть назад</b>
Начни с этого тега на первой строке.
Где особенности модели мышления {name} могут сыграть против неё именно в этот год.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>🌱 Что важно прямо сейчас</b>
Начни с этого тега на первой строке.
1-2 конкретных действия для {name} с учётом её модели и вектора года.""",
        ],
        "month": [
            base_period + f"""
...
Начни с этого тега на первой строке.
Как тактика месяца проявляется для {name} через призму вектора года и её модели мышления.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>✨ Возможности месяца</b>
Начни с этого тега на первой строке.
Что открывается именно для {name} в этом месяце.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>🔺 Риски месяца</b>
Начни с этого тега на первой строке.
Где особенности {name} могут усилить сложности именно сейчас.""",

            base_period + f"""

Напиши ТОЛЬКО этот блок: <b>🌱 Шаги на ближайшие 2 недели</b>
Начни с этого тега на первой строке.
2-3 конкретных действия для {name}.""",
        ],
        "day": [
            base_period + f"""
