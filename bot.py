...
=== КОНЕЦ ПРОФИЛЯ ==="""
    ...
    if section == "me":
        instruction = f"""Напиши анализ личности {name}. Не описание типа — живое понимание конкретного человека.

ВМЕСТО общих фраз о типе отвечай на конкретные вопросы:
- Как именно {name} проживает повседневность с этой моделью мышления?
- Что происходит у неё внутри когда что-то идёт не так?
- Где её сила проявляется неожиданно для неё самой?
- Что она делает когда устала или растеряна?
- Как это всё работает прямо сейчас — в этом году и этом месяце?

СТРУКТУРА:
✨ Кто ты есть на самом деле
Начни с чего-то точного и неожиданного — не с общего описания типа, а с конкретного наблюдения. Например: как она воспринимает мир, что её раздражает, что даёт ей силу. 2-3 абзаца максимум.
・・・・・・・・・・
🌿 Твои настоящие сильные стороны
Не список качеств — живые образы. Покажи как эти сильные стороны работают в реальных ситуациях прямо сейчас с учётом года и месяца.
・・・・・・・・・・
🔺 Где ты можешь себе мешать
Не диагноз и не критика — понимание. Покажи механизм: что происходит внутри, почему это возникает, в каких ситуациях особенно сейчас.
・・・・・・・・・・
🌱 Как превратить это в силу прямо сейчас
Один-два конкретных практических шага. Не советы из книги — что именно этому человеку делать на этой неделе.

ЗАПРЕЩЕНО:
- "рождена чтобы", "двигатель перемен", "огонь гаснет"
- Любые мотивационные клише
- Фразы которые подошли бы любому человеку с этим типом"""
