...
ЗАПРЕЩЕНО:
- Слова: "трещины", "хаос", "нестабильность", "напряжение", "тормозит", "застреваешь", "зависаешь", "ломается", "проблема", "слабость", "сложно", "тяжело", "беспокойство", "тревога", "диагноз", "критиканство", "занудство", "раздражённость"
