...
Обращение: ТЫ. {g}. Короткие абзацы — максимум 3 предложения. Говори как умный друг который хорошо знает этого человека."""
    ...
    b = {
        "me": [
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>✨ Кто ты есть на самом деле</b>\n2-3 абзаца. Начни с этого тега. Точное живое наблюдение — не описание типа, а конкретный человек прямо сейчас.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌿 Твои настоящие сильные стороны</b>\nКак они работают в этом году и месяце. Начни с этого тега. Конкретно и образно.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🔺 Где ты можешь себе мешать</b>\nПокажи механизм — почему именно сейчас. Начни с этого тега. Мягко, с пониманием.",
            base + f"\n\nНапиши ТОЛЬКО этот блок:\n<b>🌱 Как превратить это в силу прямо сейчас</b>\n1-2 конкретных действия именно для этого человека на эту неделю. Начни с этого тега.",
        ],
        "year": [
